...
关键纠正几个曾经的误判：
1. **不是 effort 问题**：真正跑出 8ns 的 GitHub baseline `codex-baseline-core-pipeline-fmax`
...
*修复提交在分支 `codex-baseline-v2-dma-prefetch-synthopt`；本说明可同步到其它 v2 分支与 `main` 供评测查阅。
